...
import {EarthGlobeIcon, DocumentIcon, CaseIcon, BlockContentIcon} from '@sanity/icons'
        ...
        return S.list()
          ...
          .items([
            ...
            S.listItem()
              .title('News Page')
              .icon(DocumentIcon)
              .child(S.editor().schemaType('newsPage').documentId('newsPage')),
            S.listItem()
              .title('Off Brief Page')
              .icon(DocumentIcon)
              .child(S.editor().schemaType('offBriefPage').documentId('offBriefPage')),
            S.listItem()
              .title('Contact Page')
              .icon(DocumentIcon)
